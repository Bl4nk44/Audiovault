...
async def get_playlist(
    ...
    logger.info(f"getPlaylist: ID={playlist_id}, entries_found={len(entries)}")  # nosemgrep: python.fastapi.log.tainted-log-injection-stdlib-fastapi.tainted-log-injection-stdlib-fastapi
    if len(entries) == 0:
        ...
        logger.info(f"getPlaylist: Raw PlaylistTrack count={raw_count.scalar()}")  # nosemgrep: python.fastapi.log.tainted-log-injection-stdlib-fastapi.tainted-log-injection-stdlib-fastapi
