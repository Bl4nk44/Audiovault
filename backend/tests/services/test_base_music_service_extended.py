...
async def test_get_tracks_null_entries(base_service):
    ...
    mock_info = {
        "_type": "playlist",
        "entries": [None, {"id": "1", "title": "Valid", "uploader": "A", "duration": 100}, None],
    }
...
async def test_get_tracks_fallback_artist(base_service):
    ...
    mock_info = {"id": "1", "title": "No Artist Track", "duration": 100}
...
async def test_get_tracks_album_fallback(base_service):
    ...
    mock_info = {
        "_type": "playlist",
        "title": "Album Title",
        "entries": [{"id": "1", "title": "Track", "artist": "A", "duration": 100}],
    }
...
async def test_get_playlist_info_no_thumbnails(base_service):
    ...
    mock_info = {"_type": "playlist", "title": "No Thumb Playlist"}
