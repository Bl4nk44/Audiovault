...
async def test_deezer_get_artist_details(deezer_service):
    mock_responses = [
        ...
        {"data": [{"id": 1, "title": "Top 1", "artist": {"name": "Mega Artist"}, "album": {"title": "A"}, "duration": 60}]}, # top tracks
        {"data": [{"id": 10, "title": "Album 1", "cover_medium": "http://cov.img", "release_date": "2024-01-01"}]} # albums
    ]
