...
def test_spotify_search_keywords(spotify_service):
    mock_results = {"tracks": {"items": [{"id": "t1", "name": "T1", "artists": [{"name": "A1", "id": "a1"}], "album": {"name": "AL1", "images": [{"url": "http://img"}]}, "duration_ms": 100}]}}
...
def test_spotify_get_track(spotify_service):
    mock_track = {"id": "t1", "name": "T1", "artists": [{"name": "A1", "id": "a1"}], "album": {"name": "AL1", "images": [{"url": "http://img"}]}, "duration_ms": 100}
...
def test_spotify_get_playlist_tracks(spotify_service):
    mock_pl = {"items": [{"track": {"id": "t1", "name": "T1", "artists": [{"name": "A1", "id": "a1"}], "album": {"name": "AL1", "images": [{"url": "http://img"}]}, "duration_ms": 100}}], "next": None}
...
def test_spotify_get_album_tracks(spotify_service):
    mock_album = {"id": "al1", "name": "Album", "artists": [{"name": "A1", "id": "a1"}], "images": [{"url": "http://img"}]}
    mock_tracks = {"items": [{"id": "t1", "name": "T1", "artists": [{"name": "A1", "id": "a1"}], "duration_ms": 100}], "next": None}
...
def test_spotify_get_artist_details(spotify_service):
    ...
    mock_top = {"tracks": [{"id": "t1", "name": "T1", "artists": [{"name": "A1", "id": "a1"}], "album": {"name": "AL1", "images": [{"url": "http://img"}]}, "duration_ms": 100}]}
    mock_albums = {"items": [{"id": "al1", "name": "Album", "images": [{"url": "http://img"}], "release_date": "2024", "total_tracks": 5, "type": "album"}], "next": None}
