...
def test_get_artist_details_full_flow(spotify_service_mocked):
    ...
    spotify_service_mocked.client.artist_top_tracks.return_value = {
        "tracks": [{"id": "t1", "name": "Hit", "artists": [{"name": "The Artist", "id": "ar1"}], "duration_ms": 100, "album": {"name": "Al", "images": []}}]
    }
    # 3. Albums (Pagination)
    p1 = {"items": [{"id": "al1", "name": "Alb1", "release_date": "2020", "total_tracks": 10, "images": [{"url": "cover"}], "type": "album"}], "next": "next"}
    p2 = {"items": [{"id": "al2", "name": "Alb2", "release_date": "2021", "total_tracks": 12, "images": [{"url": "cover"}], "type": "album"}], "next": None}
