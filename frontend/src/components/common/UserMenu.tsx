      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 mt-2 w-64 bg-black/90 backdrop-blur-xl border border-white/10 rounded-2xl shadow-xl py-2 z-50 overflow-hidden"
          >
            <div className="px-4 py-3 border-b border-white/10 flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-linear-to-br from-primary to-green-600 flex items-center justify-center shadow-lg overflow-hidden shrink-0">
            ...
            {otherSessions.length > 0 && (
              <div className="p-2 border-b border-white/5 bg-white/5">
                <p className="text-xs text-gray-400 uppercase font-bold tracking-wider px-2 mb-2 mt-1">
