...
import { User, LogOut, Settings, ChevronDown, Plus, Users } from 'lucide-react'
                ...
                {isOpen && (
                    ...
                    >
                        <div className="p-4 border-b border-white/5">
                            <p className="text-xs text-gray-400 uppercase font-bold tracking-wider mb-2">Current Account</p>
                        ...
                        {otherSessions.length > 0 && (
                            <div className="p-2 border-b border-white/5 bg-white/5">
                                <p className="text-xs text-gray-400 uppercase font-bold tracking-wider px-2 mb-2 mt-1">Switch Account</p>
