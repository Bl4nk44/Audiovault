  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        isExpanded
          ? "h-screen bg-black/90 backdrop-blur-3xl"
          : "h-24 bg-black/60 backdrop-blur-xl border-t border-white/10"
      )}
    >
      ...
      >
        ...
        <div
          className={cn(
            ...
            isExpanded ? "flex-col text-center mb-8" : "w-1/3"
          )}
        >
          <div
            className={cn(
              "relative overflow-hidden rounded-xl shadow-2xl",
              isExpanded ? "w-64 h-64 mb-4" : "w-14 h-14"
            )}
          >
        ...
        <div
          className={cn(
            ...
            isExpanded ? "absolute top-8 right-8" : "w-1/3"
          )}
        >
