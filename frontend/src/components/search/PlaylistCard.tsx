...
export default function PlaylistCard({ playlist }: PlaylistCardProps) {
    ...
    return (
        ...
        >
            ...
            <h3 className="font-bold text-white truncate group-hover:text-primary transition-colors text-center w-full">{playlist.title}</h3>
            ...
            <motion.button
                ...
                disabled={isAdded}
                className={`mt-4 mx-auto p-3 rounded-full transition-colors shadow-lg ${isAdded ? 'bg-green-500 text-black' : 'bg-white/10 text-white hover:bg-primary hover:text-black border border-white/10'
                    }`}
