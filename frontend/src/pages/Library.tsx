        ...
        <div className="space-y-6 pb-24">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gray-400">Manage your downloaded tracks ({total} items).</p>
                </div>
            ...
            {loading ? (
                ...
                <div className="text-center py-20 text-gray-500">
                    {searchQuery ? "No tracks found matching your search." : "Your library is empty or this page has no items."}
                </div>
            ) : (
                <>
                                        ...
                                        >
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <span className="font-medium text-white">{item.track.title}</span>
                                                </div>
                                            </td>
                                            <td className="px-6 py-4 text-gray-300">{item.track.artist}</td>
                                            <td className="px-6 py-4 text-gray-400">{item.track.album || '-'}</td>
            ...
            {editingItem && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
                    ...
                    >
                        <h2 className="text-xl font-bold text-white mb-4">Edit Track Info</h2>
                        <form onSubmit={handleUpdate} className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full bg-black/20 border border-white/10 rounded-lg px-3 py-2 text-white focus:border-primary"
                                />
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full bg-black/20 border border-white/10 rounded-lg px-3 py-2 text-white focus:border-primary"
                                />
                                <p className="text-xs text-yellow-500/80 mt-1">Warning: Changing filename might break playlists if not updated.</p>
                            </div>
                            ...
                            <div className="flex justify-end gap-3 mt-6">
                                ...
                                <button
                                    type="submit"
                                    className="px-4 py-2 bg-primary text-black font-bold rounded-lg hover:bg-green-400"
                                >
                                    Save Changes
                                </button>
                            </div>
