export const en = {
  ...
  watchlist: {
    ...
    syncAllDeletions: "Sync All Deletions",
    autoSyncDeletionsOn: "Auto-sync deletions: ON",
    autoSyncDeletionsOff: "Auto-sync deletions: OFF",
    syncAllSuccess: "Sync complete. Removed: {{removed}}, Skipped: {{skipped}}",
